...
export default function Footer() {
    ...
    const [icons, useIcons] = useState([
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/yeohbraddy/',
        ...
        {
            name: 'LinkedIn',
            href: 'https://www.linkedin.com/in/braddy-yeoh-945937152/',
        ...
        <FooterContainer>
            ...
            <ContactDiv>
                ...
                <InputDiv>
                    ...
                    <SendBtnDiv>
                        <SendBtn
                            href={'mailto:yeohbraddy@gmail.com?subject=' + subject + '&body=' + body}
                        >
                            Send
                        </SendBtn>
                    </SendBtnDiv>
